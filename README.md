...
</h1>[![GitHub Actions CI Status](https://github.com/nf-core/imcyto/actions/workflows/ci.yml/badge.svg)](https://github.com/nf-core/imcyto/actions/workflows/ci.yml)
...
<!-- If you use nf-core/imcyto for your analysis, please cite it using the following doi: [10.5281/zenodo.XXXXXX](https://doi.org/10.5281/zenodo.XXXXXX) --><!-- TODO nf-core: Add bibliography of tools and data used in your pipeline -->
